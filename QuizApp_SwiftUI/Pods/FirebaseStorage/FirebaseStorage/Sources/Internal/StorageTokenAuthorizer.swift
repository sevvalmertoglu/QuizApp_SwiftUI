...
class StorageTokenAuthorizer: NSObject, GTMSessionFetcherAuthorizer {
    ...
    func authorizeRequest(_: NSMutableURLRequest?, delegate _: Any, didFinish _: Selector) {
    ...
    func stopAuthorization(for _: URLRequest) {}

    func isAuthorizingRequest(_: URLRequest) -> Bool {
        return false
    }
